...
import {getRootModel, setRootModel, isInEditor, isBrowser} from '../src/utils';
...
class AEMIndex extends React.Component {
  ...
  constructor(props) {
      ...
      if (isBrowser()) {
          const {model} = props;
          setRootModel(model);
          ModelManager.initialize({model, modelClient: new CustomModelClient('http://localhost:4502')})
      }
  }
